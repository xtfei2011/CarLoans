...
@interface TFRegisteViewController ()<UITextFieldDelegate>
...
@implementation TFRegisteViewController

- (void)viewDidLoad {
    [super viewDidLoad];
    
    self.navigationItem.title = @"注 册(2/3)";
...
- (IBAction)nextStepButtonClick:(UIButton *)sender
{
    ...
    [TFNetworkTools postResultWithUrl:@"api/v1/registerCheckSmsCode" params:params success:^(id responseObject) {
        ...
        if ([responseObject[@"code"] isEqual:@200]) {
            ...
            TFRegistViewController *registVC = [[TFRegistViewController alloc] init];
            registVC.phone = self.phone;
