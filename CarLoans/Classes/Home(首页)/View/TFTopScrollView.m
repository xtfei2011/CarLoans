...
- (void)setDataSource:(NSArray *)dataSource
{
    ...
    for (int i = 0; i < _dataSource.count; i++) {
        ...
        [imageBtn setBackgroundImageForState:UIControlStateNormal withURL:[NSURL URLWithString:scrollModel.imageUrl] placeholderImage:[UIImage imageNamed:@"Image_column_default"]];
